...
export declare type TemplateNode = Text | MustacheTag | RawMustacheTag | DebugTag | ConstTag | Directive | StyleDirective | Element | InlineComponent | Window | Body | Head | Title | Options | SlotTemplate | Slot | Comment | IfBlock | EachBlock | AwaitBlock | KeyBlock;
...
export declare type InlineComponent = BasicInlineComponent | InlineSvelteComponent;
...
export declare type AttributeOrDirective = Attribute | Spread | Directive | StyleDirective;
...
export declare type Directive = DirectiveForExpression | TransitionDirective | LetDirective;
