...
exports.default = (0, utils_1.createRule)("system", {
    ...
    create(context) {
        ...
        const ignoreWarnings = (_b = (_a = context.settings) === null || _a === void 0 ? void 0 : _a["@ota-meshi/svelte"]) === null || _b === void 0 ? void 0 : _b.ignoreWarnings;
        if (ignoreWarnings && !Array.isArray(ignoreWarnings)) {
            context.report({
                loc: { line: 1, column: 0 },
                message: 'The settings["@ota-meshi/svelte"].ignoreWarnings must be an array.',
            });
            return {};
        }
        const ignoreTests = [];
        for (const ignoreWarning of ignoreWarnings || []) {
            if (typeof ignoreWarning !== "string") {
                context.report({
                    loc: { line: 1, column: 0 },
                    message: 'The array element in the settings["@ota-meshi/svelte"].ignoreWarnings must be a string.',
                });
                return {};
            }
