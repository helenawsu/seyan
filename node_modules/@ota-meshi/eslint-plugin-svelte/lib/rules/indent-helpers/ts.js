    ...
    const visitor = {
        ...
        TSEmptyBodyFunctionExpression(node) {
            ...
            if (firstToken.type === "Punctuator") {
                ...
                while (nextToken &&
                    !(0, eslint_utils_1.isOpeningParenToken)(nextToken) &&
                    nextToken.value !== "<") {
                    if (nextToken.value === "*" ||
        ...
        TSTypePredicate(node) {
            ...
            const rightToken = node.typeAnnotation &&
                (0, commons_2.getFirstAndLastTokens)(sourceCode, node.typeAnnotation).firstToken;
        ...
        TSImportType(node) {
            ...
            offsets.setOffsetElementList([node.parameter], leftParenToken, rightParenToken, 1);
            if (node.qualifier) {
